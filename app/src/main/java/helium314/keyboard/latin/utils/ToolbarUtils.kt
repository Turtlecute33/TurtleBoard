...
fun setToolbarButtonsActivatedStateOnPrefChange(buttonsGroup: ViewGroup, key: String?) {
    ...
    }, 10) // need to wait until SettingsValues are reloaded
}
...
val defaultClipboardToolbarPref by lazy {
    val default = listOf(VOICE, CLEAR_CLIPBOARD, UP, DOWN, LEFT, RIGHT, UNDO, CUT, COPY, PASTE, SELECT_WORD, CLOSE_HISTORY)
