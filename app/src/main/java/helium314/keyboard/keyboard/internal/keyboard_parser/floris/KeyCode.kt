...
object KeyCode {
    ...
    const val TEXT_FIX =                    -234
    const val TEXT_FIX_2 =                  -235
    const val VOICE_STT_INPUT =             -236
    const val TRANSLATE =                   -237
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        VOICE_INPUT, VOICE_STT_INPUT, TEXT_FIX, TEXT_FIX_2, TRANSLATE, LANGUAGE_SWITCH, SETTINGS, DELETE, ALPHA, SYMBOL, EMOJI, CLIPBOARD, CLIPBOARD_CUT, UNDO,
